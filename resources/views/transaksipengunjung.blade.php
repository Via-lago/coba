                ...
                <div class="row">
                    <div class="col-lg-8 col-md-10 mx-auto">
                        ...
                        @foreach($menus as $data)
                            <form action="/formbuypengunjung" method="post">
                            {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="id_menu" id="id_menu" value="{{ $data->id_menu }}" readonly required/>
                                </div>
                                <br>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="jenis_pengunjung" id="jenis_pengunjung"/>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="nama_menu">Nama Menu</label>
                                    <input type="text" class="form-control" name="nama_menu" id="nama_menu" value="{{ $data->nama_menu }}" readonly required/>
                                </div>
                                <br>
                                <div class="form-group">
