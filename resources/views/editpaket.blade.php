      ...
      <div class="navbar-inner">
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="/viewpaket">
        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Edit Paket</h3>
            </div>
            <div class="card-body">
            @foreach($pakets as $data)
		    <form action="/formeditpaket" method="post">
            {{ csrf_field() }}
            <input type="hidden" name="id_paket" value="{{ $data->id_paket }}" class="form-control">
            <div class="pl-lg-4">
                <div class="row">
                    <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <input id="input-nama" type="text" required="required" name="nama_paket" value="{{ $data->nama_paket }}" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <input id="input-isi" type="text" required="required" name="isi_paket" value="{{ $data->isi_paket }}" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <input id="input-harga" type="text" required="required" name="harga" value="{{ $data->harga }}" class="form-control">
                        </div>
                    </div>
                </div>
                <input type="submit" value="Simpan" class="btn btn-primary">
                <input type="reset" value="Batal" class="btn btn-danger">
                <a class="btn btn-default" href="/viewpaket">Kembali <i class="fas fa-chevron-left"></i></a>
            </div>
			</form>
			@endforeach
            </div>
