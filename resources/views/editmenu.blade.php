      ...
      <div class="navbar-inner">
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="/viewmenu">
        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Edit Menu</h3>
            </div>
            <div class="card-body">
            @foreach($menus as $data)
		        <form action="/formedit" method="post">
            {{ csrf_field() }}
            <input type="hidden" name="id_menu" value="{{ $data->id_menu }}" class="form-control">
            <div class="pl-lg-4">
                <div class="row">
                    <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <input id="input-nama" type="text" required="required" name="nama_menu" value="{{ $data->nama_menu }}" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <a class="btn btn-default" href="/viewmenu">Kembali <i class="fas fa-chevron-left"></i></a>
            </div>
			      </form>
			      @endforeach
            </div>
