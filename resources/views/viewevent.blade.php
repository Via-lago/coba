        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Pesanan Event</h3>
            </div>
            <div class="card-body">
              <table class="table align-items-center table-dark table-flush">
                ...
                <tr>
                    ...
                    <td>{{ $data->harga }}</td>
                    <td>{{ $data->tanggal }}</td>
                    <td><a class="btn btn-warning" href="/editevent/{{ $data->id_event }}"><i class="fas fa-edit"></i></a> <a class="btn btn-danger" href="/deleteevent/{{ $data->id_event }}"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
		                @endforeach
                </thead>
              </table>
