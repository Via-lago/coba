        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Add Bahan Baku</h3>
            </div>
            <div class="card-body">
              <form action="/formadddapur" method="post">
                {{ csrf_field() }}
                  <div class="pl-lg-4">
                      <div class="row">
                          <div class="col-md-10">
                              <div class="form-group">
                                  ...
                                  <input id="input-nama" type="text" name="nama_bahanbaku" required="required" class="form-control">
                              </div>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-10">
                              <div class="form-group">
                                  ...
                                  <input id="input-jenis" type="text" name="jenis_bahanbaku" required="required" class="form-control">
                              </div>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-10">
                              <div class="form-group">
                                  ...
                                  <input id="input-jumlah" type="text" name="jumlah_stok" required="required" class="form-control">
                              </div>
                          </div>
                      </div>
