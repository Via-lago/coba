        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Karyawan</h3>
            </div>
            <div class="card-body">
              <table class="table align-items-center table-dark table-flush">
                <thead class="thead-dark">
                    ...
                    <td>{{ $data->no_hp }}</td>
                    <td>{{ $data->alamat }}</td>
                    <td><a class="btn btn-warning" href="/editkaryawan/{{ $data->id_karyawan }}"><i class="fas fa-edit"></i></a> <a class="btn btn-danger" href="/deletekaryawan/{{ $data->id_karyawan }}"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
		                @endforeach
                </thead>
              </table>
              <a  class="btn btn-primary" href="/addkaryawan">Tambah Data <i class="fas fa-plus"></i></a>
            </div>
