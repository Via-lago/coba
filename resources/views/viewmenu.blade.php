            ...
            <div class="card-body">
              <table class="table align-items-center table-dark table-flush">
                <thead class="thead-dark">
                  ...
                  <td>{{ $data->harga }}</td>
			            <td><a class="btn btn-warning" href="/editmenu/{{ $data->id_menu }}"><i class="fas fa-edit"></i></a> <a class="btn btn-danger" href="/deletemenu/{{ $data->id_menu }}"><i class="fas fa-trash-alt"></i></a></td>
		              </tr>
		              @endforeach
                </thead>
              </table>
              <a  class="btn btn-primary" href="/addmenu">Tambah Data <i class="fas fa-plus"></i></a>
            </div>
