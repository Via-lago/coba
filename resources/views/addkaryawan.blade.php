        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Add Karyawan</h3>
            </div>
            <div class="card-body">
              <form action="/formaddkaryawan" method="post">
                {{ csrf_field() }}
                  <div class="pl-lg-4">
                      <div class="row">
                          <div class="col-md-10">
                              <div class="form-group">
                                  ...
                                  <input id="input-nama" type="text" name="nama_karyawan" required="required" class="form-control">
                              </div>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-10">
                              <div class="form-group">
                                  ...
                                  <input id="input-jabatan" type="text" name="jabatan" required="required" class="form-control">
                              </div>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-10">
                              <div class="form-group">
                                  ...
                                  <input id="input-email" type="text" name="email" required="required" class="form-control">
                              </div>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-10">
                              <div class="form-group">
                                  ...
                                  <input id="input-nohp" type="text" name="no_hp" required="required" class="form-control">
                              </div>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-10">
                              <div class="form-group">
                                  ...
                                  <input id="input-alamat" type="text" name="alamat" required="required" class="form-control">
                              </div>
                          </div>
                      </div>
